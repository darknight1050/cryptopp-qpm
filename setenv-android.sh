...
cp "${ANDROID_NDK_ROOT}/sources/android/cpufeatures/cpu-features.h" ./cryptopp
cp "${ANDROID_NDK_ROOT}/sources/android/cpufeatures/cpu-features.c" ./cryptopp
...
sed -e 's/= memmem/= (const char*)memmem/g' \
    ...
    ./cryptopp/cpu-features.c > ./cryptopp/cpu-features.c.fixed
mv ./cryptopp/cpu-features.c.fixed ./cryptopp/cpu-features.c

# Fix permissions. For some reason cpu-features.h is +x.
chmod u=rw,go=r ./cryptopp/cpu-features.h ./cryptopp/cpu-features.c
